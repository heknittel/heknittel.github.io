...
excerpt: '<sup>abc</sup>[MohammadTaghi Hajiaghayi](https://www.cs.umd.edu/~hajiagha/) and Marina Knittel.'
date: 2020-05-01
venue: 'AAMAS'
...
<span style="color:grey"><small>Marina Knittel and MohammadTaghi Hajiaghayi. **Matching Affinity Clustering: Improved Hierarchical Clustering at Scale with Guarantees.** *The International Conference on Autonomous Agents and Multiagent Systems,* 2020.</small></span>
