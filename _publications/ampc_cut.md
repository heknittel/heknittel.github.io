...
permalink: /publication/ampc_cut
excerpt: '<sup>abc</sup> [MohammadTaghi Hajiaghayi](https://www.cs.umd.edu/~hajiagha/), Marina Knittel, Jan Olkowski, and [Hamed Saleh](https://scholar.google.com/citations?user=8t3aDXgAAAAJ&hl=en).'
date: 2022-07-01
venue: 'SPAA'
paperurl: 'https://arxiv.org/abs/2205.14101'
bibtexurl: 'https://dblp.org/rec/conf/spaa/HajiaghayiKOS22.html?view=bibtex'
---
...
<span style="color:grey"><small>MohammadTaghi Hajiaghayi, Marina Knittel, Jan Olkowski, and Hamed Saleh. **Adaptive Massively Parallel Algorithms for Cut Problems.** *Symposium on Parallelism and Architectures,* 2022.
